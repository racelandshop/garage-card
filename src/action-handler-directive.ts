...
customElements.define('action-handler-garage-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-garage-card')) {
    return body.querySelector('action-handler-garage-card') as ActionHandler;
  }
  const actionhandler = document.createElement('action-handler-garage-card');
